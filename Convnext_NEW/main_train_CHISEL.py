...
mat = h5py.File('./datasets/data_100000_5m_50m_y_1_LoS_SS.mat', 'r')  # 读取文件，得到字典
x_train = mat['x1']  # 获取H_ori数据
x_train = np.transpose(x_train)
print(np.shape(x_train))

mat1 = h5py.File('./datasets/data_100000_5m_50m_y_2_LoS_SS.mat', 'r')  # 读取文件，得到字典
x_train1 = mat1['x2']  # 获取H_ori数据
x_train1 = np.transpose(x_train1)
print(np.shape(x_train1))

mat2 = h5py.File('./datasets/data_100000_5m_50m_y_3_LoS_SS.mat', 'r')  # 读取文件，得到字典
x_train2 = mat2['x3']  # 获取H_ori数据
x_train2 = np.transpose(x_train2)
print(np.shape(x_train2))

mat3 = h5py.File('./datasets/data_100000_5m_50m_y_4_LoS_SS.mat', 'r')  # 读取文件，得到字典
x_train3 = mat3['x4']  # 获取H_ori数据
x_train3 = np.transpose(x_train3)
print(np.shape(x_train3))

mat4 = h5py.File('./datasets/data_100000_5m_50m_y_5_LoS_SS.mat', 'r')  # 读取文件，得到字典
x_train4 = mat4['x5']  # 获取H_ori数据
x_train4 = np.transpose(x_train4)
print(np.shape(x_train4))

mat5 = h5py.File('./datasets/data_100000_5m_50m_y_6_LoS_SS.mat', 'r')  # 读取文件，得到字典
x_train5 = mat5['x6']  # 获取H_ori数据
x_train5 = np.transpose(x_train5)
print(np.shape(x_train5))

mat6 = h5py.File('./datasets/data_100000_5m_50m_y_7_LoS_SS.mat', 'r')  # 读取文件，得到字典
x_train6 = mat6['x7']  # 获取H_ori数据
x_train6 = np.transpose(x_train6)
print(np.shape(x_train6))

mat7 = h5py.File('./datasets/data_100000_5m_50m_y_8_LoS_SS.mat', 'r')  # 读取文件，得到字典
x_train7 = mat7['x8']  # 获取H_ori数据
x_train7 = np.transpose(x_train7)
print(np.shape(x_train7))

mat8 = h5py.File('./datasets/data_100000_5m_50m_y_label_LoS_SS.mat', 'r')  # 读取文件，得到字典
x_train8 = mat8['label']  # 获取H_ori数据
...
# np.savetxt('./model_pt/convnext_RMSE_r_4_LoS_SS11.csv', RMSE_R, delimiter=',')
# np.savetxt('./model_pt/convnext_RMSE_theta_4_LoS_SS11.csv', RMSE_THETA, delimiter=',')
# np.savetxt('./model_pt/convnext_RMSE_2D.csv', RMSE_2D_g, delimiter=',')

torch.save(G.state_dict(), './model_pt/CHISEL_7.pt')
