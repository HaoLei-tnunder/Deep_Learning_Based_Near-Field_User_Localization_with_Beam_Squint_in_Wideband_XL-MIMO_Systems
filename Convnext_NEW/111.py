...
mat8 = h5py.File('./datasets/data_50000_5m_50m_y_label.mat', 'r')  # 读取文件，得到字典
...
np.savetxt('./model_pt/convnext_RMSE_r_1.csv', RMSE_R, delimiter=',')
np.savetxt('./model_pt/convnext_RMSE_theta_1.csv', RMSE_THETA, delimiter=',')
# np.savetxt('./model_pt/convnext_RMSE_2D.csv', RMSE_2D_g, delimiter=',')

torch.save(G.state_dict(), './model_pt/convnext_1.pt')
